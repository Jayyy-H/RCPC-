...
def ipr_compute_score(predict_str: str, ground_truth: str, format_weight: float = 0.1) -> Dict[str, float]:
    """
    输入: (predict_str, ground_truth)
    ...
    ok, think_txt, ans_txt = _format_is_strict_single_pair(predict_str)
